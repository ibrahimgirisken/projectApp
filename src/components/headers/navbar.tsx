                                    ...
                                    megamenu.map(({ image, links, title }, index) => (
                                        <div key={index} className="homemenu">
                                            <div className="homemenu-thumb">
                                                <Image width={213} height={366} sizes="100vw" src={image} alt="img" />
                                                        ...
                                                        <ul className="submenu">
                                                            {
                                                                dropdown.submenu.map((subDropdown, index) =>
                                                                    <li key={index}><Link href={subDropdown.link}>{subDropdown.title}</Link></li>
                                                                )
                                                            }
                                                        </ul>
                                                    </li>
                                                    :
                                                    <li ><Link href={dropdown.link}>{dropdown.title}</Link></li>
                                            }
                                        </Fragment>
                                    )
                                })
